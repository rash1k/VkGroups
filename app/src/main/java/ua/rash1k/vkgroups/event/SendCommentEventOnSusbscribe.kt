...
class SendCommentEventOnSusbscribe(val ownerId: Int,
                                   val postId: Int,
                                   val message: String,
                                   val attachment: VKAttachments)
    : ObservableOnSubscribe<VKResponse> {
    ...
    override fun subscribe(emitter: ObservableEmitter<VKResponse>) {
        ...
        val vkApi = VKApi.wall().addComment(vkParameters)
